...
import { FiPlus, FiBook, FiUser, FiLogOut, FiHome } from "react-icons/fi";
              ...
              {navigationItems.map((item) => {
                ...
                return (
                  <Link
                    key={item.name}
                    to={item.path}
                    className={`py-4 px-1 border-b-2 font-medium text-base transition-colors duration-200 flex items-center space-x-2 whitespace-nowrap ${
                      isActive
